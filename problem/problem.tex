...
% 不难发现，若请求的内容在计算机 $j$ 上，则获得内容的最短时间为计算机 $i$ 到计算机 $j$ 的最短路长度
...
显然把 $1$ 条边：$1 \rightarrow 4$ 或 $4 \rightarrow 5$ 的边权变为 $0$ 后，路径 $1 \rightarrow 4 \rightarrow 5$ 的长度为 $3$，为 $1 \Rightarrow 5$ 的最短路径。
